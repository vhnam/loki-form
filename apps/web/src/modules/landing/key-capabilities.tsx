...
const KeyCapabilities = () => {
  return (
    <section id="features" className="border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-body py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16 text-center">
          <h2 className="mb-4 text-xl text-bright">Key Capabilities</h2>
          <p className="text-lg text-gray-7 dark:text-dark-1">Built for scale, designed for flexibility</p>
        </div>
