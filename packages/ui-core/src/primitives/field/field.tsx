...
import { Label, Separator } from '@repo/ui-core/primitives';
...
type FieldErrorProps = ComponentProps<'div'> & { errors?: Array<{ message?: string } | undefined> };
...
function FieldDescription({ className, ...props }: FieldDescriptionProps) {
  return (
    <p
      ...
      className={cn(
        'text-dimmed text-sm leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance',
